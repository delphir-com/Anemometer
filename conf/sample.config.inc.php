...
$conf['history_defaults'] = array(
	...
	'table_fields' => array('date', 'index_ratio','query_time_avg','rows_sent_avg','fact.reviewed_status','ts_cnt','Query_time_sum','Lock_time_sum','Rows_sent_sum','Rows_examined_sum')
);
...
$conf['report_defaults'] = array(
	...
	'dimension-ts_min_end'	=> date("Y-m-d H:i:s"),
	'table_fields' => array('checksum','snippet', 'category', 'index_ratio','query_time_avg','rows_sent_avg','fact.reviewed_status','ts_cnt','Query_time_sum','Lock_time_sum','Rows_sent_sum','Rows_examined_sum'),
